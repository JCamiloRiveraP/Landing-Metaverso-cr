...
const InsightCard = ({ imgUrl, title, subtitle, index }) => (
  <motion.div variants={fadeIn('up', 'spring', index * 0.5, 1)} className="flex md:flex-row flex-col gap-4">
    <img src={imgUrl} alt="planeta 1" className="md:w-[270px] w-full h-[250px] rounded-[32px] object-cover" />
    ...
    <div className="w-full flex justify-between items-center">
      ...
      <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] rounded-full bg-transparent border-[1px] border-white ">
        <img src="arrow.svg" alt="flecha" className="w-[40%] h-[40%] object-contain" />
      </div>
    </div>
  </motion.div>
);
